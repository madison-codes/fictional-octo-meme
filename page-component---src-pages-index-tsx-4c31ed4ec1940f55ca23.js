...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = ({ items, pathname, Link, inverted, toggleSidebar }) => {
	    return React.createElement(semantic_ui_react_1.Container, null, React.createElement(semantic_ui_react_1.Menu, { size: "large", pointing: true, secondary: true, inverted: inverted }, React.createElement(semantic_ui_react_1.Menu.Item, { as: "a", className: "mobile only", icon: "sidebar", onClick: toggleSidebar }), items.map(item => {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.menuItems = [{ name: "Home", path: "/", exact: true, icon: "home", inverted: true }, { name: "Account", path: "/account/", exact: true, icon: "info circle" }, { name: "Documentation", path: "/docs/", exact: false, icon: "newspaper" }, { name: "Test", path: "/test/", exact: false, icon: "newspaper" }, { name: "Support", path: "/support/", exact: false, icon: "newspaper" }];
...
//# sourceMappingURL=page-component---src-pages-index-tsx-4c31ed4ec1940f55ca23.js.map