...
/***/ (function(module, exports, __webpack_require__) {
	...
	class DocsNav extends React.Component {
	    ...
	    render() {
	        return React.createElement("div", { id: 'docs-nav' }, React.createElement(List_1.List, { style: style }, React.createElement(List_1.ListItem, { primaryText: "Overview", containerElement: React.createElement(gatsby_link_1.default, { to: "/overview/" }) })), React.createElement(List_1.ListItem, { primaryText: "Guides", nestedItems: [React.createElement(List_1.ListItem, { key: 1, primaryText: "Getting Started", nestedItems: [React.createElement(List_1.ListItem, { key: 1, primaryText: "Introduction to Docs", containerElement: React.createElement(gatsby_link_1.default, { to: "/docs/" }) }), React.createElement(List_1.ListItem, { key: 2, primaryText: "Glossary" })] }), React.createElement(List_1.ListItem, { key: 2, primaryText: "User Overview", nestedItems: [React.createElement(List_1.ListItem, { key: 1, primaryText: "Overview" }), React.createElement(List_1.ListItem, { key: 2, primaryText: "Init Overview" }), React.createElement(List_1.ListItem, { key: 3, primaryText: "Password Escrow" }), React.createElement(List_1.ListItem, { key: 4, primaryText: "User Syncing" }), React.createElement(List_1.ListItem, { key: 5, primaryText: "Generating" })] }), React.createElement(List_1.ListItem, { key: 3, primaryText: "Document", nestedItems: [React.createElement(List_1.ListItem, { key: 1, primaryText: "Overview" }), React.createElement(List_1.ListItem, { key: 2, primaryText: "Encrypt" }), React.createElement(List_1.ListItem, { key: 3, primaryText: "Decrypt" }), React.createElement(List_1.ListItem, { key: 4, primaryText: "Update Encrypted Data" })] }), React.createElement(List_1.ListItem, { key: 4, primaryText: "Storage", nestedItems: [React.createElement(List_1.ListItem, { key: 1, primaryText: "Overview" }), React.createElement(List_1.ListItem, { key: 2, primaryText: "Document Store" })] }), React.createElement(List_1.ListItem, { key: 5, primaryText: "Groups", nestedItems: [React.createElement(List_1.ListItem, { key: 1, primaryText: "Introduction" }), React.createElement(List_1.ListItem, { key: 2, primaryText: "Create and Manage Groups" }), React.createElement(List_1.ListItem, { key: 3, primaryText: "Add and Remove Memebers from a Group" }), React.createElement(List_1.ListItem, { key: 4, primaryText: "Administrtive Role" }), React.createElement(List_1.ListItem, { key: 5, primaryText: "Group Creator" })] }), React.createElement(List_1.ListItem, { key: 6, primaryText: "Device", nestedItems: [React.createElement(List_1.ListItem, { key: 1, primaryText: "Overview" }), React.createElement(List_1.ListItem, { key: 2, primaryText: "Authorize" }), React.createElement(List_1.ListItem, { key: 3, primaryText: "Deauthorize" })] }), React.createElement(List_1.ListItem, { key: 7, primaryText: "Sharing", nestedItems: [React.createElement(List_1.ListItem, { key: 1, primaryText: "Overview" }), React.createElement(List_1.ListItem, { key: 2, primaryText: "Sharing Docsuments" }), React.createElement(List_1.ListItem, { key: 3, primaryText: "Sharing with Users" }), React.createElement(List_1.ListItem, { key: 4, primaryText: "Sharing with Users' Devices" }), React.createElement(List_1.ListItem, { key: 5, primaryText: "Sharing with Groups" })] })] }));
	    }
	}
...
//# sourceMappingURL=page-component---src-pages-docs-tsx-5db4a93810c9d459b152.js.map